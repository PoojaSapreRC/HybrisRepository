 ...
 */
package com.onercyber.service.impl;
...
public class DefaultMyonetrainingService implements MyonetrainingService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyonetrainingService.class);
	...
	{
		return DefaultMyonetrainingService.class.getResourceAsStream("/myonetraining/sap-hybris-platform.png");
	}
