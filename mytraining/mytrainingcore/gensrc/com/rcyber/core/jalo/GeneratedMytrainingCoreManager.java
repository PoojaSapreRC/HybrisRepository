...
import com.rcyber.core.jalo.ApparelProduct;
import com.rcyber.core.jalo.ApparelSizeVariantProduct;
import com.rcyber.core.jalo.ApparelStyleVariantProduct;
import com.rcyber.core.jalo.ElectronicsColorVariantProduct;
import com.rcyber.core.jalo.Rice;
...
public abstract class GeneratedMytrainingCoreManager extends Extension
{
	...
	public Rice createRice(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( MytrainingCoreConstants.TC.RICE );
			return (Rice)type.newInstance( ctx, attributeValues );
		}
		catch( JaloGenericCreationException e)
		{
			final Throwable cause = e.getCause();
		...
		{
			throw new JaloSystemException( e ,"error creating Rice : "+e.getMessage(), 0 );
		}
	}
	
	public Rice createRice(final Map attributeValues)
	{
		return createRice( getSession().getSessionContext(), attributeValues );
	}
